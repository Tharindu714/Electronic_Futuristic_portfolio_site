        ...
        <div class="col-12 mt-1">
          <div class="row">
            <div class="col-12 text-center bg-dark">
              <h2 class=" text-primary title1 fw-bolder mb-1 ">ADD OTHER PHOTOS</h2>
            </div>
            <hr class="border border-1 border-light" />
            <div class="col-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-12">
                              <div class="row">
                                <div class="col-12 text-center">
                                  <label class="form-label fw-bold text-light text-uppercase" style="font-size:20px;">Add Product Image</label>
                                </div>
                            ...
                            <div class="col-12 text-center">
                              <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3 mb-3">
                                <button class="btn btn-outline-primary fw-bold" onclick="addProduct();">ADD & SAVE</button>
                              </div>
