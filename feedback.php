...
<head>
	<meta charset="utf-8">
	<title>Chanaka Electronics | Feedback</title>
	<!-- Stylesheets -->
	...
	<div class="page-wrapper">
		...
		<section class="contact-form-section">
			<div class="auto-container">
				<!-- Sec Title -->
				<div class="sec-title">
					<h2 class="text-light">Leave Your Feedback Here</h2>
				</div>
							...
							<div class="contact-form">
								<div class="row clearfix">
									...
									<div class="form-group col-lg-12 col-md-12 col-sm-12">
										<input type="text" title="Don't use puncuations" id="feedback"
											placeholder="Leave your Feedback here ( Use 250 characters )" required>
									</div>

									<div class="col-lg-12 col-md-12 col-sm-12">
										<button class="theme-btn btn-style-one" style="cursor: pointer;"
											onclick="feedbackpro();"><span class="txt font-weight-bold">Submit
					...
					<div class="info-column col-lg-5 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<ul class="contact-info-list">
								<li><strong>Address :</strong><br>No: 50, Independent Trade Center, <br> Bandarawela.
								</li>
							</ul>
							<!-- Contact Info List -->
							<ul class="contact-info-list">
								...
								<li><strong>Email : </strong><a
										href="mailto:chanakaelectro@gmail.com">chanakaelectro@gmail.com</a></li>
							</ul>
							<!-- Contact Info List -->
